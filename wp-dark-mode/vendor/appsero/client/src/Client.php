...
defined( 'ABSPATH' ) || exit; // phpcs:ignore Universal.PHP.DisallowExitDieParentheses.Found, Universal.PHP.RequireExitDieParentheses.Missing -- Vendor SDK guard; leave exit form as-is.
