...
export default defineConfig(
	{
		...
		build: {
			rollupOptions: {
				input: {
					'dashboard-widget': path.resolve( __dirname, 'dashboard-widget.js' ),
				},
				output: {
					entryFileNames: 'js/admin-dashboard-widget.min.js',
					assetFileNames: 'css/admin-dashboard-widget.min.css',
					format: 'iife',
				},
			},
